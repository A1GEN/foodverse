...
const resources = {
  en: {
    translation: {
      ...
      catalog: "Catalog",
      footer: {
        description: "Your favorite food delivery service. Fresh products, fast delivery, excellent quality.",
      ...
      checkout: {
        ...
        error: "Error sending order. Try again later."
      },
      success: {
        title: "Order Successfully Placed!",
        message: "We received your order and will contact you soon for confirmation.",
        home: "Home",
  ...
  ru: {
    translation: {
      ...
      catalog: "Каталог",
      footer: {
        description: "Ваш любимый сервис доставки еды. Свежие продукты, быстрая доставка, отличное качество.",
        ...
        copyright: "© 2024 FoodVerse. Все права защищены."
      },
      checkout: {
        title: "Оформление заказа",
        backToCart: "Назад в корзину",
        empty: "Ваша корзина пуста",
        shopRecipes: "Смотреть рецепты",
        ...
        error: "Ошибка при отправке заказа. Попробуйте позже."
      },
      success: {
        title: "Заказ успешно оформлен!",
        message: "Мы получили ваш заказ и скоро свяжемся с вами для подтверждения.",
        home: "На главную",
